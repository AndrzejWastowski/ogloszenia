...
class EstatesCreateUpdateRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            'estates_groups_id' => 'required|integer|min:1',            
    ...
    public function messages()
    {
        return [
            ...
            'estates_classified_enum:re' => 'required|in:sprzedam,kupię,zamienię,oddam,wypożyczę',
        ];
    }
