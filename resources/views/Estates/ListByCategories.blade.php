...
<div class="container">
    <nav class="card p-3 pb-0 mb-3 bg-white" aria-label="breadcrumb">
        <ol class="breadcrumb" >
            ...
            <li class="breadcrumb-item"> <a href="/nieruchomosci/{{ $category[0]->link }}">{{ $category[0]->name }} </a></li>  
        </ol>
    </nav> 
    <div class="row">
        <div class="col-3">
    ...
    @php $highlighted = 'style=background-color:'.$content->highlighted.';' @endphp
        ...
        <div class="col-xl-12"><h5 class="card-title"> <strong><a href="{{ route('EstatesContentsById', ['categories'=> $content->EstatesCategories->link,'id' => $content->id ]) }}">{{ $content->name }} </a></strong></h5></div> 
                ...
                <div class="row">  
                    ...
                    <div class="mb-3">
                        <div class="offset-lg-9 offset-sm-4">
                            <form action="{{ route('EstatesContentsById', ['categories'=> $content->EstatesCategories->link,'id' => $content->id ]) }}" method="get" enctype="text/plain"><div>
