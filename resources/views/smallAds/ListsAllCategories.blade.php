    ...
    <div class="col-3">
        <div class="accordion" id="menu_boczne">
            <div class="accordion-item">
                ...
                <div id="kategoria_" class="accordion-collapse  " aria-labelledby="naglowek_" data-bs-parent="#menu_boczne">
                    <div class="accordion-body">
                        <ul class="">
                            @foreach($subcategories as $subcategory)                              
                                        
                                            <li class="mb-2"><a href="/drobne/cfbcvbcvb/{{ $subcategory->link }}">{{ $subcategory->name }}</a></li>
