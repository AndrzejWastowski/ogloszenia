...
<div class="row justify-content-center">
    ...
    <h3><strong>Samochody Osobowe - Promocja</strong></h3>
        ...
        <!-- your steps here -->
            ...
            <div class="step" data-target="#podsumowanie-part">
                <button type="button" class="step-trigger" role="tab" aria-controls="podsumowanie-part" id="podsumowanie-part-trigger">
                    ...
                    <form action="{{ route('cars_promotion_post') }}"  method="POST" enctype="multipart/form-data" role="form" name="formPromotion">
                            @csrf
