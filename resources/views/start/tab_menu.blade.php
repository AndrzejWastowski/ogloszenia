...
<nav>
	<div class="nav nav-tabs" id="nav-tab" role="tablist">
		...
		<button class="nav-link" id="nav-job-automoto" data-bs-toggle="tab" data-bs-target="#nav-automoto" type="button" role="tab" aria-controls="nav-automoto" aria-selected="false">Motoryzacja</button>
	</div>
</nav>
