...
<div class="row">
    ...
    <div class="accordion" id="menu_boczne">
        ...
        @if ($category->link == $category->id)  @endif  

        <div class="accordion-item">
        <h2 class="accordion-header" id="naglowek_{{ $category->id }}">
            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#kategoria_{{ $category->id }}" aria-expanded="true" aria-controls="kategoria_{{ $category->id }}">
                 {{ $category->name }}
            </button>
        </h2>

        <div id="kategoria_{{ $category->id }}" class="accordion-collapse collapse " aria-labelledby="naglowek_{{ $category->id }}" data-bs-parent="#menu_boczne">
