        ...
        <div class="col-3">
            <div class="accordion  bg-white" id="menu_boczne">
                ...
                @foreach($categories as $category)   
                    ...
                    @endif
                    <div class="accordion-item">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#podkategorie_{{ $category->id }}" aria-expanded="{{ $trufalse }}" aria-controls="podkategorie_{{ $category->id }}">
